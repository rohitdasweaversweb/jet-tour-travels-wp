				...
				<div id="respond">
					...
					<?php else: ?>
						<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
							<div class="row">
								<?php if ($user_ID): ?>
									<p class="col-md-4">Logged in as <a
								...
								<?php else: ?>
									<p class="col-md-4">
										...
										<input type="text" name="author" placeholder="Enter Name" id="author"
								...
								<p class="col-12">
									...
									<textarea name="comment" id="comment" cols="62" placeholder="Message" rows="5" tabindex="4"
										maxlength="150"></textarea>

								</p>
								<p class="col-12"><input name="submit" type="submit" id="submit" tabindex="5"
