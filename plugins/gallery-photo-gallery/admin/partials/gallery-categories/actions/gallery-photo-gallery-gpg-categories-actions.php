<?php
    ...
    if( isset( $_POST['ays_submit'] ) ) {
        $_POST['id'] = $id;
        $result = $this->gallery_cats_obj->add_edit_gpg_gallery_category( $_POST );
    }
    if(isset($_POST['ays_apply'])){
        $_POST["id"] = $id;
        $_POST['ays_change_type'] = 'apply';
        $this->gallery_cats_obj->add_edit_gpg_gallery_category($_POST);
    }
    ...
    if ( isset( $id ) && !is_null( $id ) ) {
        $next_gallery_cat = $this->get_next_or_prev_gallery_gpg_cat_by_id( $id, "next" );
    ...
    <div class="container-fluid">
        ...
        <form class="ays-gpg-category-form" id="ays-gpg-category-form" method="post">
            ...
            <div class="form-group row ays-galleries-button-box">
                ...
                <?php
                    wp_nonce_field('gpg_gallery_category_action', 'gpg_gallery_category_action');
