...
namespace GalleryPhotoGallery\Helpers;
...
class GalleryPhotoGalleryPluginSilentUpgrader extends \Plugin_Upgrader {
	...
	public function install_package( $args = [] ) {
		...
		self::ays_gpg_set_time_limit( 300 );
     ...
     */
    public static function ays_gpg_set_time_limit( $limit = 0 ) {
